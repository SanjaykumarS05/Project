...
@section('content1')
    ...
    <form action="{{ route('members.store') }}" method="POST">
        ...
        <input type="text" id="contact" name="contact" value="{{ old('contact', '+91') }}"
        ...
        <input type="text" id="school_college" name="school_college" value="{{ old('school_college') }}" placeholder="School/College">
        <label for="login_id">Created By (Login)</label>
